...
public class AudioSensorManager extends BaseSensor implements DutyCyclingManager.DutyCyclingEventListener {
    ...
    private AudioDispatcherTest dispatcher;
    ...
    private synchronized void addNewSensingTask() {
        dispatcher = new AudioDispatcherFactoryTest().fromDefaultMicrophone(getSamplingRate(), getBufferSize(), 0);
     ...
     * @author Joren Six
     */
    class AudioDispatcherTest implements Runnable {


        /**
         * Log messages.
         */
        private final Logger LOG = Logger.getLogger(AudioDispatcherTest.class.getName());
         ...
         */
        public AudioDispatcherTest(final TarsosDSPAudioInputStream stream, final int audioBufferSize, final int bufferOverlap){
        ...
        public void run() {
            ...
            try {
                ...
                bytesRead = readNextAudioBlock(false);
            } catch (IOException e) {
         ...
         *             been closed.
         */
        public int readNextAudioBlock(boolean partial) throws IOException {
     ...
     * @see AudioDispatcher
     */
    public class AudioDispatcherFactoryTest {
         ...
         */
        public AudioDispatcherTest fromDefaultMicrophone(final int sampleRate,
            ...
            if(minAudioBufferSizeInSamples <= audioBufferSize ){
                ...
                return new AudioDispatcherTest(audioStream,audioBufferSize,bufferOverlap);
            }else{
         ...
         */
        public AudioDispatcher fromPipe(final String source,final int targetSampleRate, final int audioBufferSize,final int bufferOverlap){
